...
public class Const {
    ...
    //测试地址同盾json文件存放地址
    public static final String TD_TEST_JSON_PATH="/Users/yicg/IdeaProjects/ctwork/src/main/json/TEST_TD.json";


    //线上参数存放路径
    public static final String TD_PROD_JSON_PATH="/Users/yicg/IdeaProjects/ctwork/src/main/json/PROD_TD.json";
